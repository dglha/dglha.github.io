<template>
  <Layout>
    <div class="container has-text-centered post-heading">
      ...
      <div class="title is-4 is-hidden-mobile" v-html="($page.post.title)" />
      <div class="title is-5 is-hidden-tablet" v-html="($page.post.title)" />
    ...
    <div class="container post-content is-max-widescreen">
    ...
    <!-- <div class="container post-comment">
      <vue-disqus
        ...
        :url="'https://fb.com/ha.duong212' + $url($page.post.path)"
